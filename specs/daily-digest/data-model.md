...
### InputRequest
User invocation of the daily-digest skill
...
2. Within each group, rank by credibility score, then freshness score as tiebreaker
...
| Entity | Constraint |
|--------|-----------|
| **InputRequest.topic** | Non-empty, max 100 chars, alphanumeric + hyphens + underscores + spaces |
